...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            extent: [-10558772.726412, -2835356.090679, 10311868.119627, 8855866.832944],
            units: 'm'})
    })
});
...
map.getView().fit([571203.097626, 6706831.389998, 727515.902374, 6807657.009998], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
		...
		var sourceAttribution = document.createElement('li');
		sourceAttribution.innerHTML = '<a>Réalisation Eric CAZIN - DDT45/SUADT/DCDDT/PCPT</a> &middot; ';
		...
		attributionList.insertBefore(sourceAttribution, firstLayerAttribution);
